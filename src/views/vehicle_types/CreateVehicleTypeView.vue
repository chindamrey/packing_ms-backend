    ...
    <div class="page-wrapper">
        <div class="form-card">
            ...
            <div class="card-header">
                <RouterLink class="back-btn" :to="{ name: 'vehicle-type.index' }" variant="secondary"
                ...
                <div class="title-group">
                    ...
                    <div>
                        <h1 class="form-title">Add Vehicle Type</h1>
                        <p class="form-subtitle">Add your vehicle type details below</p>
                    </div>
                </div>
            </div>
            ...
            <div class="form-body">
                ...
                <div class="field-group" :class="{ focused: nameFocused, filled: form.name, error: errors.name }">
                    <label class="field-label">
                        ...
                        Vehicle Type Name <span class="required-star">*</span>
                    </label>
                    <div class="input-wrapper">
                        ...
                        <div class="input-suffix">
                            ...
                            <svg v-if="form.name && !errors.name" class="valid-icon" width="16" height="16"
                ...
                <div class="field-group"
                    ...
                    <div class="input-wrapper number-wrapper">
                        ...
                        <input v-model.number="form.numberInstand" type="number" class="field-input number-input"
...
import { useVehicleTypeStore } from '@/stores/vehicle_types.js'
...
const handleSubmit = async () => {
    ...
    const res = await vehicleTypeStore.createVehicleType(JSON.parse(JSON.stringify(form)))
    console.log(res);
    isLoading.value = true
