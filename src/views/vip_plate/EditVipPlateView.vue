                ...
                <div class="field-group">
                    ...
                    <div class="input-wrapper radio-wrapper">
                        <label class="radio-option">
                            <input type="radio" value="1" v-model="form.isActive" />
                            <span class="radio-label">Active</span>
                        </label>

                        <label class="radio-option">
                            <input type="radio" value="0" v-model="form.isActive" />
...
onMounted(async () => {
    ...
    form.discount = data.discount_percentage;
    form.owner_name = data.owner_name;
})
// const discountFocused = ref(false)
...
function validateDiscount() {
    if (!form.discount) {
        errors.discount = 'Please select a status.'
    } else {
        errors.discount = ''
    }
}
